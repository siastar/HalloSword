...
const evilStuff = {
    ...
    makeKnife: function() {
        evilBuilder.weaponNick = "a simple knife";
        evilBuilder.weaponLevel = 1;
    ...
    makeHammer: function() {
        evilBuilder.weaponNick = "a war hammer";
        evilBuilder.weaponLevel = 1;
    ...
    makeJacket: function() {
        evilBuilder.armorNick = "a leather jacket";
    ...
    makeCoat: function() {
        evilBuilder.armorNick = "a rusty coat";
        evilBuilder.armorLevel = 1;
    ...
    makeBlueHat: function() {
        evilBuilder.armorNick = "a blue hat";
        evilBuilder.armorLevel = 1;
    ...
    makeBlackArmor: function() {
        evilBuilder.armorNick = "a black armor";
        evilBuilder.armorLevel = 1;
