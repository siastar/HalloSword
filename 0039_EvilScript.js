    ...
    */
    ...
    protoFolks: function() {
        ...
        let aNewGuy = Object.create(Object.prototype, {
            /*prototype of the generic char-*/
            evilDude: {
                value: this.evilDude,
            },
            /*  links to generateGuy function   */
            /*-acter which is made of objec-*/
            equippedArmor: {
                value: this.equippedArmor,
            },
            /*  links to generateGuy function   */
            /*-ts such as kind, weapon,armo-*/
            equippedWeapon: {
                value: this.equippedWeapon,
            },
            /*  links to generateGuy function   */
            ...
            /* test method no actual porpuse */
            introduceYerself: {
                value: this.introduceYerself(),
            },
            /* test method no actual porpuse */
        });
        return (aNewGuy);
...
*/
    ...
    protoKind: function() {
        ...
        let evilDudeGuy = Object.create(Object.prototype, {
            ...
            /*protoKind takes   preset values*/
            kind: {
                value: this.chKind,
                configurable: true,
                writable: true
            },
            /*chKind refers to the properties of the main object evilBuilder      */
            /*from makeZombie makeGhost etc  */
            nick: {
                value: this.chNick,
                configurable: true,
                writable: true
            },
            /*chNick refers to the properties of the main object evilBuilder      */
            ...
            /*chLevel refers to the properties of the main object evilBuilder     */
            /*generateGuy function and       */
            health: {
                value: this.chHealth,
                configurable: true,
                writable: true
            },
            /*chHealth refers to the properties of the main object evilBuilder    */
            /*switched by buildIt function   */
            attack: {
                value: this.chAttack,
                configurable: true,
                writable: true
            },
            /*chAttack refers to the properties of the main object evilBuilder    */
            /*returns an object which could  */
            defence: {
                value: this.chDefence,
                configurable: true,
                writable: true
            },
            /*chDefence refers to the properties of the main object evilBuilder   */
            /*be a player or a zombie or a   */
            initiative: {
                value: this.chInitiative,
                configurable: true,
                writable: true
            },
            /*chInitiative refers to the properties of the main object evilBuilder*/
            /*ghost etc etc                  */
            side: {
                value: this.chSide,
                configurable: true,
    ...
    */
    protoWeapon: function() {
        ...
        let aWeapon = Object.create(Object.prototype, {
            /*as well as protoKind, protoWea-*/
            nick: {
                value: this.weaponNick,
            },
            /*-pon defines an object weapon  */
            damage: {
                value: this.weaponDamage,
            },
            /*picking preset from makeSword, */
            range: {
                value: this.weaponRange,
            },
            attackMod: {
                value: this.weaponAttackMod,
            },
            /*makeAxe etc.It is called by    */
            prop1: {
                value: this.weaponProp1,
            },
            /*generateGuy function and retur-*/
            prop2: {
                value: this.weaponProp2,
            },
            /*-ns an object sword, axe, etc  */
            prop3: {
                value: this.weaponProp3,
            },
            /*                               */
            dice: {
                value: this.weaponDice,
            },
        });
        return (aWeapon);
    },
    ...
    */
    protoArmor: function() {
        ...
        let anArmor = Object.create(Object.prototype, {
            /*same as previous*/
            nick: {
                value: this.armorNick,
            },
            protection: {
                value: this.armorProtection,
            },
            level: {
                value: this.armorLevel,
            },
            defenceMod: {
                value: this.armorDefenceMod,
            },
            prop1: {
                value: this.armorProp1,
            },
            prop2: {
                value: this.armorProp2,
            },
            prop3: {
                value: this.armorProp3,
            },
        });
        return (anArmor);
    },
    ...
    */
    ...
    generateGuy: function(kind, weapon, armor) {
        ...
        /*links to protoFolks */
        this.evilDude = this.buildIt(kind); /* buildIt grabs called kind presets              */
        /*links to protoWeapon*/
        this.equippedWeapon = this.buildIt(weapon); /* buildIt grabs called weapon presets            */
        /*links to protoArmor */
        this.equippedArmor = this.buildIt(armor); /* buildIt grabs called armor presets             */
    ...
    */
    buildIt: function(it) {
        ...
        switch (select) {
            // build kind
            case "zombie":
                build = evilStuff.makeZombie();
                break; /*object evilStuff is in another file*/
            case "ghost":
                build = evilStuff.makeGhost();
                break;
            case "vampire":
                build = evilStuff.makeVampire();
                break;
                // build weapons
            case "sword":
                build = evilStuff.makeSword();
                break;
            case "axe":
                build = evilStuff.makeAxe();
                break;
            case "knife":
                build = evilStuff.makeKnife();
                break;
                // build armors
            case "jacket":
                build = evilStuff.makeJacket();
                break;
            case "coat":
                build = evilStuff.makeCoat();
                break;
            case "bluehat":
                build = evilStuff.makeBlueHat();
                break;
                // build other items
            default:
                build = "we don't have this thing in our inventory";
        }
        return (build);
    },
    ...
    /* about test function at the moment not in use:
      ...
      this methods are not used anymore
                                                                                                                              */
    sayHi: function() {
        return " Hi ! I'm a character !!! I'm going to kill you, btw";
    },

    introduceYerself: function() {
        return ("I'm a " + this.chKind + " and my name is " + this.chNick);
    },
...
const evilTools = {
    ...
    teamBuilder: function(qnt, kind, weapon, armor, side) {
        ...
        for (let i = 1; i < qnt + 1; i++) { // iterates to create a qnt number of characters
            ...
            /*x=x+y === x+=y   */
            newGuyX.evilDude.nick += (" " + (i - 1)); // gives a id number to the characters in the pack
...
const evilTurn = {
    ...
    engageAtWill: function(sVsJ) {
        ...
        if (survivedSith == 0 || survivedJedi == 0) {
            fightNoMore = true
        } else {
            fightNoMore = false
        }
    ...
    roundLoop: function(sVsJ) {
        ...
        while (endFight == false) {
            ...
            /*origin of player_*/
            let player = sVsJ[counter]; // set the player in the array of chars, it will change at every turn																console.log(player);
    ...
    turnClock: function(sVsJ, player_) {
        ...
        /*origin of enemy*/
        let enemy = this.evalTarget(enemies); //ok, for the moment this is totally random for the moment
...
*/
    ...
    evalDistance: function(player, enemy) {
        ...
        if (targetDistance <= player.equippedWeapon.range) {
            reachable = true
        } else if (targetDistance > player.equippedWeapon.range) {
            reachable = false
        }
        return (reachable);
    },
    ...
    attackEnemy: function(player_, enemy_) {
        ...
        if (totAttack < totDefence) {
            console.log("[[[ DODGED !!! ]]]");
            enemyHit_ = false;
        } else if (totAttack >= totDefence) {
            console.log("[[[ HIT !!! ]]]");
            enemyHit_ = true;
        } else {
