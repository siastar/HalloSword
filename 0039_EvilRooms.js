...
const evilMapGen = {
    ...
    protoTile: function() {
        ...
        let justAtile = Object.create(Object.prototype, {
            ...
            prop1: {
                value: this.tileProp1,
            },
            prop2: {
                value: this.tileProp2,
            },
            prop3: {
                value: this.tileProp3,
            },
            prop4: {
                value: this.tileProp4,
            },
            prop5: {
                value: this.tileProp5,
            },
            prop6: {
                value: this.tileProp6,
            },
            prop7: {
                value: this.tileProp7,
            },
            prop8: {
                value: this.tileProp8,
            },
            prop9: {
                value: this.tileProp9,
            },
        });
        return (justAtile);
    },
